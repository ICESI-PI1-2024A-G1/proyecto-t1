...
def travel_advance_request(request):
    try:
        ...
        print(e)
        messages.error(request, f"Error al llenar el formulario")
        return redirect("forms:travel_advance_request")
    ...
    try:
        ...
        if request.method == "GET":
            ...
            if form_data.get("signatureStatus") != "Yes":
                ...
                travel_legalization.signature_status = (
        ...
        print(e)
        messages.error(request, f"Error al llenar el formulario")
        return redirect("forms:travel_expense_legalization")
    ...
    try:
        ...
        if request.method == "GET":
            ...
            if form_data.get("signatureStatus") != "Yes":
                ...
                advance_legalization.icesi_balance_value = form_data[
                    "icesiBalanceValue"
                ]
        ...
        print(e)
        messages.error(request, f"Error al llenar el formulario")
        return redirect("forms:advance_legalization")
...
def billing_account(request):
    try:
        ...
        print(e)
        messages.error(request, f"Error al llenar el formulario")
        return redirect("forms:billing_account")
...
def requisition(request):
    try:
        ...
        print(e)
        messages.error(request, f"Error al llenar el formulario")
        return redirect("forms:requisition")
